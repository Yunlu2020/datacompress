...
class BertClassfilyModel(nn.Module):
    ...
    def __init__(self, class_size, pretrained_name='bert-base-uncased'):
        ...
        """
        super(BertClassfilyModel, self).__init__()
    ...
    def forward(self, inputs,label=None):
        ...
        if label:
            loss_score = nn.CrossEntropyLoss(categories_numberic,label)
            return loss_score
...
class BertForQuestionAnswering(nn.Module):
    ...
    def __init__(self,pretrained_name='bert-base-uncased'):
        super(BertForQuestionAnswering, self)
        self.bert = BertModel.from_pretrained(pretrained_name,
                                              return_dict=True)
